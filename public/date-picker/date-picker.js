(function($) {
	...
	var
		picker_node_el = 'div.datepicker.picker-focus';
	...
	$.fn.datePicker = function(options) {
		return $(this).each(function(){
			if($(this).is('input')&&!$(this).hasClass('picker-input')) {
				...
				var
					input = $(this),
					id = 'datepicker-' + Object.keys(pickers).length;
				...
				$('<div>', {
					class: 'datepicker' + picker_modal + ' ' + picker_theme + ' ' + picker_fx_class + ' ' + picker_large_class,
					id: id,
					html: $('<div>', {
						class: 'picker'
					})
